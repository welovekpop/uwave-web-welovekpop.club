  ...
  return function (dispatch, getState) {
    ...
    return dispatch((0, _RequestActionCreators.post)('/booth/skip', payload, {
      onStart: function onStart() {
        return {
          type: _ActionTypes.SKIP_DJ_START,
          payload: payload
        };
      },
      onComplete: function onComplete() {
        return {
          type: _ActionTypes.SKIP_DJ_COMPLETE,
          payload: payload
        };
      },
...
function removeWaitlistUserStart(user) {
  return {
    type: _ActionTypes.REMOVE_USER_START,
    payload: {
      user: user
    }
  };
...
function removeWaitlistUserComplete(user) {
  return {
    type: _ActionTypes.REMOVE_USER_COMPLETE,
    payload: {
      user: user
    }
  };
...
function moveWaitlistUserStart(user, position) {
  return {
    type: _ActionTypes.MOVE_USER_START,
    payload: {
      user: user,
      position: position
    }
...
function moveWaitlistUserComplete(user, position) {
  return {
    type: _ActionTypes.MOVE_USER_COMPLETE,
    payload: {
      user: user,
      position: position
    }
...
function addUserRole(user, role) {
  ...
  return (0, _RequestActionCreators.put)("/users/" + userID + "/roles/" + role, {}, {
    onStart: function onStart() {
      return {
        type: _ActionTypes.ADD_USER_ROLES_START,
        payload: {
          user: user,
          roles: [role]
        }
    ...
    onComplete: function onComplete() {
      return {
        type: _ActionTypes.ADD_USER_ROLES_COMPLETE,
        payload: {
          user: user,
          roles: [role]
        }
...
function removeUserRole(user, role) {
  ...
  return (0, _RequestActionCreators.del)("/users/" + userID + "/roles/" + role, {}, {
    onStart: function onStart() {
      return {
        type: _ActionTypes.REMOVE_USER_ROLES_START,
        payload: {
          user: user,
          roles: [role]
        }
    ...
    onComplete: function onComplete() {
      return {
        type: _ActionTypes.REMOVE_USER_ROLES_COMPLETE,
        payload: {
          user: user,
          roles: [role]
        }
...
function muteUserStart(userID, duration) {
  return {
    type: _ActionTypes.MUTE_USER_START,
    payload: {
      userID: userID,
      duration: duration
    }
...
function muteUserComplete(userID, duration) {
  return {
    type: _ActionTypes.MUTE_USER_COMPLETE,
    payload: {
      userID: userID,
      duration: duration
    }
...
function unmuteUserStart(userID) {
  return {
    type: _ActionTypes.UNMUTE_USER_START,
    payload: {
      userID: userID
    }
  };
...
function unmuteUserComplete(userID) {
  return {
    type: _ActionTypes.UNMUTE_USER_COMPLETE,
    payload: {
      userID: userID
    }
  };
...
function banUserStart(userID, duration, permanent) {
  return {
    type: _ActionTypes.BAN_USER_START,
    payload: {
      userID: userID,
      duration: duration,
      permanent: permanent
...
function banUserComplete(ban) {
  return {
    type: _ActionTypes.BAN_USER_COMPLETE,
    payload: ban
  };
}
/**
