...
function flattenPlaylistItem(item) {
  return (0, _extends3.default)({}, item.media, item);
}

function loadPlaylistStart(playlistID, page) {
  var _ref = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
      _ref$sneaky = _ref.sneaky,
      sneaky = _ref$sneaky === undefined ? false : _ref$sneaky;

  return {
    type: _playlists.LOAD_PLAYLIST_START,
    payload: { playlistID: playlistID },
    meta: { page: page, sneaky: sneaky }
  };
}
...
function loadPlaylistComplete(playlistID, media, pagination) {
  return {
    ...
    payload: { playlistID: playlistID, media: media },
    meta: pagination
  };
}
...
function loadPlaylist(playlistID) {
  ...
  return (0, _RequestActionCreators.get)('/playlists/' + playlistID + '/media', {
    qs: { page: page, limit: MEDIA_PAGE_SIZE },
    onStart: function onStart() {
      return loadPlaylistStart(playlistID, page, meta);
    },
    onComplete: function onComplete(res) {
      return loadPlaylistComplete(playlistID, (0, _mergeIncludedModels2.default)(res).map(flattenPlaylistItem), {
...
function filterPlaylistItemsStart(playlistID, page, filter) {
  return {
    ...
    payload: { playlistID: playlistID, filter: filter },
    meta: { page: page }
  };
}
...
function loadFilteredPlaylistItems(playlistID) {
  var page = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
  ...
  return function (dispatch, getState) {
    ...
    return dispatch((0, _RequestActionCreators.get)('/playlists/' + playlistID + '/media', {
      qs: { filter: filter, page: page, limit: MEDIA_PAGE_SIZE },
      onStart: function onStart() {
        return filterPlaylistItemsStart(playlistID, page, filter);
      },
      onComplete: function onComplete(res) {
        return filterPlaylistItemsComplete(playlistID, (0, _mergeIncludedModels2.default)(res).map(flattenPlaylistItem), {
          page: res.meta.offset / res.meta.pageSize,
          pageSize: res.meta.pageSize,
...
function createPlaylist(name) {
  ...
  return (0, _RequestActionCreators.post)('/playlists', { name: name, description: description, shared: shared }, {
    onStart: function onStart() {
      return createPlaylistStart({ name: name, description: description, shared: shared }, tempId);
    },
    onComplete: function onComplete(res) {
      return function (dispatch, getState) {
...
function renamePlaylist(playlistID, name) {
  return (0, _RequestActionCreators.put)('/playlists/' + playlistID + '/rename', { name: name }, {
    onStart: function onStart() {
      return {
    ...
    onComplete: function onComplete(_ref2) {
      ...
      return {
        ...
        payload: { playlistID: playlistID, name: data.name }
      };
    },
    onError: function onError(error) {
      return {
        ...
        error: true,
        payload: error,
        meta: { playlistID: playlistID, name: name }
      };
    }
  });
}
...
function closeAddMediaMenu() {
  return { type: _playlists.CLOSE_ADD_MEDIA_MENU };
}

function addMediaStart(playlistID, media, afterID) {
  return {
...
function addMedia(playlist, items) {
  var afterID = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  ...
  return (0, _RequestActionCreators.post)('/playlists/' + playlist._id + '/media', payload, {
    ...
    onComplete: function onComplete(res) {
      return addMediaComplete(playlist._id, res.meta.playlistSize, { afterID: afterID, media: (0, _mergeIncludedModels2.default)(res).map(flattenPlaylistItem) });
    },
    onError: function onError(error) {
      return {
        type: _playlists.ADD_MEDIA_COMPLETE,
...
function updateMediaStart(playlistID, mediaID, props) {
  return {
    ...
    payload: { playlistID: playlistID, mediaID: mediaID, props: props }
  };
}
...
function updateMediaComplete(playlistID, mediaID, media) {
  return {
    ...
    payload: { playlistID: playlistID, mediaID: mediaID, media: media }
  };
}
  ...
  return (0, _RequestActionCreators.put)('/playlists/' + playlistID + '/media/' + mediaID, props, {
    ...
    onError: function onError(error) {
      return {
        ...
        payload: error,
        error: true,
        meta: { playlistID: playlistID, mediaID: mediaID, props: props }
      };
    }
  });
}
...
function removeMediaStart(playlistID, items) {
  return {
    ...
    payload: { playlistID: playlistID, medias: items }
  };
}
...
function removeMedia(playlistID, items) {
  ...
  return (0, _RequestActionCreators.del)('/playlists/' + playlistID + '/media', { items: itemIDs }, {
    onStart: function onStart() {
...
function moveMediaStart(playlistID, items, afterID) {
  return {
...
function moveMediaComplete(playlistID, items, afterID) {
  return {
...
function moveMedia(playlistID, medias, opts) {
  return function (dispatch, getState) {
    ...
    return dispatch((0, _RequestActionCreators.put)('/playlists/' + playlistID + '/move', { items: items, after: afterID }, {
      onStart: function onStart() {
...
function shufflePlaylist(playlistID) {
  return function (dispatch) {
    ...
    var loadOperation = loadPlaylist(playlistID, 0, { sneaky: true });
