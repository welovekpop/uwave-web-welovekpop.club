...
function setPlaylists(playlists) {
  return {
    type: _ActionTypes.LOAD_ALL_PLAYLISTS_COMPLETE,
    payload: {
      playlists: playlists
    }
  };
...
function flattenPlaylistItem(item) {
  return (0, _extends2.default)({}, item.media, item);
}
...
function loadPlaylistStart(playlistID, page, _temp) {
  ...
  return {
    type: _ActionTypes.LOAD_PLAYLIST_START,
    payload: {
...
function loadPlaylistComplete(playlistID, media, pagination) {
  return {
    type: _ActionTypes.LOAD_PLAYLIST_COMPLETE,
    payload: {
      playlistID: playlistID,
      media: media
    },
...
function filterPlaylistItemsStart(playlistID, page, filter) {
  return {
    type: _ActionTypes.FILTER_PLAYLIST_ITEMS_START,
    payload: {
      playlistID: playlistID,
      filter: filter
    },
...
function filterPlaylistItemsComplete(playlistID, media, pagination) {
  return {
    type: _ActionTypes.FILTER_PLAYLIST_ITEMS_COMPLETE,
    payload: {
      playlistID: playlistID,
      media: media
    },
...
function filterPlaylistItems(playlistID, filter) {
  return function (dispatch) {
    dispatch({
      type: _ActionTypes.FILTER_PLAYLIST_ITEMS,
      payload: {
        playlistID: playlistID,
        filter: filter
      }
...
function selectPlaylist(playlistID) {
  return function (dispatch) {
    dispatch({
      type: _ActionTypes.SELECT_PLAYLIST,
      payload: {
        playlistID: playlistID
      }
    });
...
function playlistCycled(playlistID) {
  return {
    type: _ActionTypes.PLAYLIST_CYCLED,
    payload: {
      playlistID: playlistID
    }
  };
...
function activatePlaylistStart(playlistID) {
  return {
    type: _ActionTypes.ACTIVATE_PLAYLIST_START,
    payload: {
      playlistID: playlistID
    }
  };
...
function activatePlaylistComplete(playlistID) {
  return {
    type: _ActionTypes.ACTIVATE_PLAYLIST_COMPLETE,
    payload: {
      playlistID: playlistID
    }
  };
...
function createPlaylistStart(props, tempId) {
  return {
    type: _ActionTypes.CREATE_PLAYLIST_START,
    payload: props,
    meta: {
      tempId: tempId
    }
...
function createPlaylistComplete(playlist, tempId) {
  return {
    type: _ActionTypes.CREATE_PLAYLIST_COMPLETE,
    payload: {
      playlist: playlist
    },
    meta: {
...
function renamePlaylist(playlistID, name) {
  return (0, _RequestActionCreators.put)("/playlists/" + playlistID + "/rename", {
    ...
    onStart: function onStart() {
      return {
        type: _ActionTypes.RENAME_PLAYLIST_START,
        payload: {
          playlistID: playlistID,
          name: name
        }
    ...
    onComplete: function onComplete(_ref2) {
      var data = _ref2.data;
      return {
        type: _ActionTypes.RENAME_PLAYLIST_COMPLETE,
        payload: {
          playlistID: playlistID,
          name: data.name
        }
...
function deletePlaylistStart(playlistID) {
  return {
    type: _ActionTypes.DELETE_PLAYLIST_START,
    payload: {
      playlistID: playlistID
    }
  };
...
function deletePlaylistComplete(playlistID) {
  return {
    type: _ActionTypes.DELETE_PLAYLIST_COMPLETE,
    payload: {
      playlistID: playlistID
    }
  };
...
function closeAddMediaMenu() {
  return {
    type: _ActionTypes.CLOSE_ADD_MEDIA_MENU
  };
}

function addMediaStart(playlistID, media, location) {
  return {
    type: _ActionTypes.ADD_MEDIA_START,
    payload: {
      playlistID: playlistID,
      media: media,
      location: location
...
function addMediaComplete(playlistID, newSize, insert) {
  return {
    type: _ActionTypes.ADD_MEDIA_COMPLETE,
    payload: {
      playlistID: playlistID,
      newSize: newSize,
...
function updateMediaStart(playlistID, mediaID, props) {
  return {
    type: _ActionTypes.UPDATE_MEDIA_START,
    payload: {
      playlistID: playlistID,
      mediaID: mediaID,
      props: props
...
function updateMediaComplete(playlistID, mediaID, media) {
  return {
    type: _ActionTypes.UPDATE_MEDIA_COMPLETE,
    payload: {
      playlistID: playlistID,
      mediaID: mediaID,
      media: media
...
function removeMediaStart(playlistID, items) {
  return {
    type: _ActionTypes.REMOVE_MEDIA_START,
    payload: {
      playlistID: playlistID,
      medias: items
    }
...
function removeMediaComplete(playlistID, newSize, removedMedia) {
  return {
    type: _ActionTypes.REMOVE_MEDIA_COMPLETE,
    payload: {
      playlistID: playlistID,
      newSize: newSize,
...
function moveMediaStart(playlistID, items, location) {
  return {
    type: _ActionTypes.MOVE_MEDIA_START,
    payload: {
      playlistID: playlistID,
      location: location,
      medias: items
...
function moveMediaComplete(playlistID, items, location) {
  return {
    type: _ActionTypes.MOVE_MEDIA_COMPLETE,
    payload: {
      playlistID: playlistID,
      location: location,
      medias: items
...
function moveMedia(playlistID, medias, opts) {
  return function (dispatch, getState) {
    ...
    return dispatch((0, _RequestActionCreators.put)("/playlists/" + playlistID + "/move", (0, _extends2.default)({
      items: items
    }, location), {
      onStart: function onStart() {
...
function shufflePlaylistStart(playlistID) {
  return {
    type: _ActionTypes.SHUFFLE_PLAYLIST_START,
    payload: {
      playlistID: playlistID
    }
  };
...
function shufflePlaylistComplete(playlistID) {
  return function (dispatch) {
    dispatch({
      type: _ActionTypes.SHUFFLE_PLAYLIST_COMPLETE,
      payload: {
        playlistID: playlistID
      }
    });
