...
function request(method, url, opts) {
  ...
  return {
    ...
    payload: (0, _objectSpread2.default)({}, requestOpts, {
      method: method,
      url: url
    }),
    meta: {
...
var post = function post(url, data, opts) {
  ...
  return request('post', url, (0, _objectSpread2.default)({
    data: data
  }, opts));
};
...
var put = function put(url, data, opts) {
  ...
  return request('put', url, (0, _objectSpread2.default)({
    data: data
  }, opts));
};
...
var del = function del(url, data, opts) {
  ...
  return request('delete', url, (0, _objectSpread2.default)({
    data: data
  }, opts));
