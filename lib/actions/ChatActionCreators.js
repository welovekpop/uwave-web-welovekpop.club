...
function receiveMotd(text) {
  return {
    type: _ActionTypes.RECEIVE_MOTD,
    payload: text
  };
}
...
function removeMessage(id) {
  return {
    type: _ActionTypes.REMOVE_MESSAGE,
    payload: {
      _id: id
    }
  };
...
function removeMessagesByUser(userID) {
  return {
    type: _ActionTypes.REMOVE_USER_MESSAGES,
    payload: {
      userID: userID
    }
  };
...
function removeAllMessages() {
  return {
    type: _ActionTypes.REMOVE_ALL_MESSAGES
  };
}

function expireMute(userID) {
  return {
    type: _ActionTypes.UNMUTE_USER,
    payload: {
      userID: userID
    }
  };
...
function setMotdStart(motd) {
  return {
    type: _ActionTypes.SET_MOTD_START,
    payload: motd
  };
}
...
function setMotdComplete(motd) {
  return {
    type: _ActionTypes.SET_MOTD_COMPLETE,
    payload: motd
  };
}
