...
function socketConnect() {
  return {
    type: _auth.SOCKET_CONNECT
  };
}

function socketReconnect() {
  return {
    type: _auth.SOCKET_RECONNECT
  };
}

function setAuthenticationStrategies(strategies) {
  return {
    type: _auth.AUTH_STRATEGIES,
    payload: {
