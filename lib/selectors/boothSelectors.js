...
var canSkipSelector = exports.canSkipSelector = (0, _reselect.createSelector)(historyIDSelector, isCurrentDJSelector, _userSelectors.currentUserSelector, function (historyID, isCurrentDJ, user) {
  if (!historyID || !user) {
    return false;
  }
