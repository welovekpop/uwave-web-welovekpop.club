...
function createUwaveStore() {
  ...
  var currentReducers = (0, _extends4.default)({}, reducers, {
  ...
  (0, _redux.combineReducers)(currentReducers), initialState, (0, _redux.compose)(
  ...
  if (process.env.NODE_ENV === 'development' && module.hot) {
    ...
    module.hot.accept('../reducers', function () {
      store.replaceReducer((0, _redux.combineReducers)((0, _extends4.default)({}, reducers, {
        sources: (0, _createSourcesReducer2.default)(options)
      })));
    });
  }
  ...
  store.mount = function (name, reducer) {
    ...
    currentReducers = (0, _extends4.default)({}, currentReducers, (_extends2 = {}, _extends2[name] = reducer, _extends2));
