...
var _ReconnectingWebSocket = require('../utils/ReconnectingWebSocket');
...
var actions = {
  ...
  waitlistMove: function waitlistMove(_ref11) {
    ...
    return (0, _WaitlistActionCreators.movedInWaitlist)({ userID: userID, moderatorID: moderatorID, position: position, waitlist: waitlist });
  },
...
function middleware() {
  ...
  return function (_ref19) {
    ...
    function isOpen() {
      return socket && socket.readyState === _ReconnectingWebSocket2.default.OPEN;
    }
