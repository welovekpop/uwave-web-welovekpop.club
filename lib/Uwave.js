...
var _createGenerateClassName = _interopRequireDefault(require("./utils/createGenerateClassName"));
...
function () {
  function Uwave(options, session) {
    ...
    this.generateClassName = (0, _createGenerateClassName.default)();
  ...
  _proto.renderToDOM = function renderToDOM(target) {
    ...
    var element = (0, _jsx2.default)(_react.default.StrictMode, {}, void 0, this.getComponent());
    (0, _reactDom.render)(element, target);
  };
