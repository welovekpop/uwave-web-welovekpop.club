...
(0, _ChatCommands.register)('wlclear', 'Remove everyone from the waitlist.', { guard: _userSelectors.isModeratorSelector, action: _WaitlistActionCreators.modClearWaitlist });

(0, _ChatCommands.register)('wllock', 'Lock the waitlist.', { guard: _userSelectors.isModeratorSelector, action: _WaitlistActionCreators.modLockWaitlist });

(0, _ChatCommands.register)('wlunlock', 'Unlock the waitlist.', { guard: _userSelectors.isModeratorSelector, action: _WaitlistActionCreators.modUnlockWaitlist });
