...
function (_React$Component) {
  ...
  function NewPlaylist() {
    ...
    return (_temp = _this = _React$Component.call.apply(_React$Component, [this].concat(args)) || this, _this.state = {
      ...
      return Promise.resolve(_this.props.onCreatePlaylist(playlistName)).then(_this.closeDialog.bind((0, _assertThisInitialized2.default)(_this)));
  ...
  _proto.render = function render() {
    ...
    return (0, _jsx2.default)(_react.default.Fragment, {}, void 0, (0, _jsx2.default)(_Menu.MenuItem, {
...
var _default = enhance(NewPlaylist); //# sourceMappingURL=NewPlaylist.js.map
