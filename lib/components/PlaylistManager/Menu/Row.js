...
var PlaylistRow = (_dec = (0, _reactDnd.DropTarget)(_DDItemTypes.MEDIA, playlistTarget, collect), _dec(_class = function (_React$Component) {
...
PlaylistRow.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  playlist: _react2.default.PropTypes.object,
  ...
  onAddToPlaylist: _react2.default.PropTypes.func
} : {};
