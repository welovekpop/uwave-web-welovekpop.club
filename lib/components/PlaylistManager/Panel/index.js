...
var _MoveToLast = require('../../MediaList/Actions/MoveToLast');

var _MoveToLast2 = _interopRequireDefault(_MoveToLast);
...
var makeActions = function makeActions(_ref) {
  ...
  return function (media, selection, index) {
    ...
    }, 'first'), index === 0 && !isFiltered && (0, _jsx3.default)(_MoveToLast2.default, {
      onLast: function onLast() {
        return onMoveToLast(media, selection);
      }
    }, 'last'), (0, _jsx3.default)(_EditMedia2.default, {
