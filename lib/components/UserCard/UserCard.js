...
var _CardContent = require('material-ui/Card/CardContent');
...
var UserCard = function UserCard(_ref) {
  ...
  return (0, _jsx3.default)(_Card2.default, {
    ...
    title: user.username,
    subheader: (0, _jsx3.default)(_UserRoles2.default, {
      roles: user.roles
    }),
  ...
  }), (0, _jsx3.default)(_CardContent2.default, {
    className: 'UserCard-joinDate'
  }, void 0, (0, _jsx3.default)(_Typography2.default, {}, void 0, 'Joined: ', (0, _formatJoinDate2.default)(user.createdAt))), (0, _jsx3.default)(_CardActions2.default, {
