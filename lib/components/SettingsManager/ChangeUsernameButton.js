...
function (_React$Component) {
  ...
  function ChangeUsernameButton() {
    ...
    return (_temp = _this = _React$Component.call.apply(_React$Component, [this].concat(args)) || this, _this.state = {
      ...
      return _this.props.onChangeUsername(name).then(_this.closeDialog.bind((0, _assertThisInitialized2.default)(_this)));
...
var _default = enhance(ChangeUsernameButton); //# sourceMappingURL=ChangeUsernameButton.js.map
