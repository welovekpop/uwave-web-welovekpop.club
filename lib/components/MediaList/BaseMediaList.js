...
var BaseMediaList = function (_React$Component) {
  (0, _inherits3.default)(BaseMediaList, _React$Component);

  function BaseMediaList() {
    var _temp, _this, _ret;

    (0, _classCallCheck3.default)(this, BaseMediaList);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = (0, _possibleConstructorReturn3.default)(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = { selection: (0, _immutable2.default)(_this.props.media) }, _this.renderList = function (items, ref) {
      var ListComponent = _this.props.listComponent;

      return _react2.default.createElement(ListComponent, { ref: ref }, items);
...
BaseMediaList.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  onRequestPage: _propTypes2.default.func,
  listComponent: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.func]).isRequired,
  rowComponent: _propTypes2.default.func.isRequired,
