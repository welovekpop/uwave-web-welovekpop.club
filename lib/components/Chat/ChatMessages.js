...
var _specialMessages = require('./specialMessages');

var _specialMessages2 = _interopRequireDefault(_specialMessages);
...
var ChatMessages = function (_React$Component) {
  ...
  ChatMessages.prototype.renderMessage = function renderMessage(msg) {
    var SpecialMessage = _specialMessages2.default[msg.type];
    if (SpecialMessage) {
