...
var Votes = function Votes(_ref) {
  ...
  return (0, _jsx3.default)('div', {
    ...
    className: (0, _classnames2.default)('HistoryVotes-icon', isUpvote && 'ResponseButton-icon--upvoted')
    ...
    className: (0, _classnames2.default)('HistoryVotes-icon', isDownvote && 'ResponseButton-icon--downvoted')
  }), (0, _jsx3.default)('span', {
    className: 'ResponseButton-count'
