...
var Video = function (_React$Component) {
  ...
  Video.prototype.componentDidMount = function componentDidMount() {
    if (_screenfull2.default.enabled) {
      _screenfull2.default.on('change', this.handleFullscreenChange);
    }
  };
  ...
  Video.prototype.render = function render() {
    ...
    return _react2.default.createElement('div', {
      ...
      url: media.thumbnail
    }), (0, _jsx3.default)(_Player2.default, {
      enabled: enabled,
      size: size,
      volume: volume,
      isMuted: isMuted,
      media: media,
      seek: seek
    }), isFullscreen && (0, _jsx3.default)(_VideoMouseMoveCapture2.default, {
