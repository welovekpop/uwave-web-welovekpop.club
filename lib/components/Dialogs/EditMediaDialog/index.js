...
var _SwapHoriz = require('material-ui-icons/SwapHoriz');
...
var EditMediaDialog = function (_React$Component) {
  ...
  function EditMediaDialog() {
    ...
    }, _this.title = (0, _uniqueId2.default)('editmedia'), _this.labelStart = (0, _uniqueId2.default)('editmedia'), _this.labelEnd = (0, _uniqueId2.default)('editmedia'), _this.handleSubmit = function (e) {
      e.preventDefault();
  ...
  EditMediaDialog.prototype.render = function render() {
    ...
    return (0, _jsx3.default)(_Dialog2.default, {
      classes: {
        paper: (0, _classnames2.default)('Dialog', 'EditMediaDialog', contentClassName)
      },
      open: open,
    ...
    }, void 0, t('dialogs.editMedia.title')), (0, _jsx3.default)(_Dialog.DialogContent, {
...
exports.default = enhance(EditMediaDialog);
