...
var PromptDialog = function (_React$Component) {
  ...
  function PromptDialog() {
    ...
    }, _this.title = (0, _uniqueId2.default)('title'), _this.handleSubmit = function (event) {
  ...
  PromptDialog.prototype.render = function render() {
    var _props = this.props,
        ...
        props = (0, _objectWithoutProperties3.default)(_props, ['children', 'icon', 'inputType', 'placeholder', 'submitLabel', 'title', 'bodyClassName', 'contentClassName', 'titleClassName']);

    var _state = this.state,
        busy = _state.busy,
        value = _state.value;

    return _react2.default.createElement(_Dialog2.default, (0, _extends3.default)({
      fullWidth: true
    }, props, {
      classes: {
        paper: (0, _classnames2.default)('Dialog', contentClassName)
      },
      onClose: this.handleClose,
      'aria-labelledby': this.title
    }), (0, _jsx3.default)(_Dialog.DialogTitle, {
      className: (0, _classnames2.default)('Dialog-title', titleClassName),
      id: this.title
    }, void 0, title), (0, _jsx3.default)(_Dialog.DialogContent, {
      className: (0, _classnames2.default)('Dialog-body', bodyClassName)
