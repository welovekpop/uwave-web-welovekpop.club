...
function (_React$Component) {
  ...
  function FooterBar(props) {
    ...
    _this.handleSkipTurn = _this.handleSkipTurn.bind((0, _assertThisInitialized2.default)(_this));
    _this.handleJoinWaitlist = _this.handleJoinWaitlist.bind((0, _assertThisInitialized2.default)(_this));
    _this.handleLeaveWaitlist = _this.handleLeaveWaitlist.bind((0, _assertThisInitialized2.default)(_this));
    return _this;
  }
...
var _default = enhance(FooterBar); //# sourceMappingURL=index.js.map
