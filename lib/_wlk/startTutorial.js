...
function startTutorial() {
  ...
  return Promise.all([script, Promise.resolve().then(() => require('uwave-tutorial/distr/stylesheets/sideshow.min.css')), Promise.resolve().then(() => require('uwave-tutorial/distr/fonts/sideshow-fontface.min.css'))]).then(function (_ref) {
    var Sideshow = _ref[0];
