...
var _PlaylistPanel = _interopRequireDefault(require("../components/PlaylistManager/PlaylistPanel"));
...
var mergeProps = function mergeProps(state, _ref2, props) {
  ...
  return (0, _objectSpread2.default)({}, props, state, (0, _redux.bindActionCreators)({
...
var _default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps, mergeProps)(_PlaylistPanel.default); //# sourceMappingURL=PlaylistPanel.js.map
