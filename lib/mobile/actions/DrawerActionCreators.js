...
function setDrawer(val) {
  return { type: _ActionTypes.SET_DRAWER_OPEN, payload: val };
}
...
function toggleDrawer() {
  return { type: _ActionTypes.TOGGLE_DRAWER_OPEN };
}

function setUsersDrawer(val) {
  return { type: _ActionTypes.SET_USERS_DRAWER_OPEN, payload: val };
}
