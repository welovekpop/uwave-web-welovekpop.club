...
function fixVolume(state) {
  if (state.volume < 0) return (0, _extends2.default)({}, state, {
    volume: 0
  });
  if (state.volume > 100) return (0, _extends2.default)({}, state, {
    volume: 100
  });
  return state;
}
...
function reduce(state, action) {
  ...
  switch (type) {
    case _ActionTypes.LOAD_SETTINGS:
      // Loading settings defaults to the initial state.
      return (0, _extends2.default)({}, initialState, payload, {
        ...
        notifications: payload ? (0, _extends2.default)({}, initialState.notifications, payload.notifications) : initialState.notifications
      });

    case _ActionTypes.CHANGE_SETTING:
...
var _default = (0, _compose.default)(fixVolume, reduce);
