...
var _extends5 = _interopRequireDefault(require("@babel/runtime/helpers/builtin/extends"));
...
function deselectAll(playlists) {
  return (0, _object.default)(playlists, function (playlist) {
    return playlist.selected ? (0, _extends5.default)({}, playlist, {
      selected: false
    }) : playlist;
  });
}
...
function reduce(state, action) {
  ...
  switch (type) {
    case _ActionTypes.INIT_STATE:
      ...
      return (0, _extends5.default)({}, state, {
        playlists: (0, _indexBy.default)(payload.playlists.map(function (playlist) {
          return (0, _extends5.default)({}, playlist, {
        ...
        // for a moment.
        playlistItems: payload.activePlaylist && payload.firstActivePlaylistItem ? (0, _extends5.default)({}, state.playlistItems, (_extends4 = {}, _extends4[payload.activePlaylist] = [payload.firstActivePlaylistItem], _extends4)) : state.playlistItems,
        activePlaylistID: payload.activePlaylist,
        selectedPlaylistID: payload.activePlaylist
      });

    case _ActionTypes.LOAD_ALL_PLAYLISTS_COMPLETE:
      return (0, _extends5.default)({}, state, {
        playlists: (0, _indexBy.default)(payload.playlists, '_id')
      });

    case _ActionTypes.ACTIVATE_PLAYLIST_START:
    ...
    case _ActionTypes.ACTIVATE_PLAYLIST_COMPLETE:
      if (error) {
    ...
    case _ActionTypes.LOAD_PLAYLIST_START:
      {
    ...
    case _ActionTypes.LOAD_PLAYLIST_COMPLETE:
      if (error) {
        return setPlaylistLoading(state, meta.playlistID, false);
      }
    ...
    case _ActionTypes.FILTER_PLAYLIST_ITEMS:
    ...
    case _ActionTypes.FILTER_PLAYLIST_ITEMS_COMPLETE:
      {
        // Only the selected playlist can be filtered.
        if (payload.playlistID !== state.selectedPlaylistID) {
          return state;
        ...
        return (0, _extends5.default)({}, state, {
          currentFilter: (0, _extends5.default)({}, currentFilter, {
            items: items
          })
        });
      }

    case _ActionTypes.PLAYLIST_CYCLED:
      return updatePlaylistItems(state, payload.playlistID, function (items, playlist) {
    ...
    case _ActionTypes.CREATE_PLAYLIST_START:
      {
        var _assign;
    ...
    case _ActionTypes.CREATE_PLAYLIST_COMPLETE:
      if (error) {
        return (0, _extends5.default)({}, state, {
      ...
      return (0, _extends5.default)({}, state, {
        playlists: (0, _objectAssign.default)(deselectAll((0, _except.default)(state.playlists, "" + meta.tempId)), (_assign2 = {}, _assign2[payload.playlist._id] = (0, _extends5.default)({}, payload.playlist, {
          selected: true
        }), _assign2)),
        selectedPlaylistID: payload.playlist._id
      });

    case _ActionTypes.RENAME_PLAYLIST_START:
      return setPlaylistLoading(state, payload.playlistID);

    case _ActionTypes.RENAME_PLAYLIST_COMPLETE:
      {
        if (error) {
          return setPlaylistLoading(state, meta.playlistID, false);
        }
    ...
    case _ActionTypes.DELETE_PLAYLIST_START:
      return setPlaylistLoading(state, payload.playlistID);

    case _ActionTypes.DELETE_PLAYLIST_COMPLETE:
      if (error) {
        return setPlaylistLoading(state, meta.playlistID, false);
      }
    ...
    case _ActionTypes.ADD_MEDIA_START:
      return setPlaylistLoading(state, payload.playlistID);

    case _ActionTypes.ADD_MEDIA_COMPLETE:
      if (error) {
        return setPlaylistLoading(state, meta.playlistID, false);
      }
    ...
    case _ActionTypes.UPDATE_MEDIA_START:
      return updatePlaylistItems(state, payload.playlistID, function (items) {
        return items.map(function (media) {
          return media && media._id === payload.mediaID ? (0, _extends5.default)({}, media, {
            loading: true
          }) : media;
        });
      });

    case _ActionTypes.UPDATE_MEDIA_COMPLETE:
      return updatePlaylistItems(state, payload.playlistID, function (items) {
        return items.map(function (media) {
          return media && media._id === payload.mediaID ? (0, _extends5.default)({}, media, payload.media, {
            loading: false
          }) : media;
        });
      });

    case _ActionTypes.MOVE_MEDIA_START:
      {
    ...
    case _ActionTypes.MOVE_MEDIA_COMPLETE:
      return updatePlaylistItems(state, payload.playlistID, function (items) {
        return processMove(items, payload.medias, payload.location);
      });

    case _ActionTypes.REMOVE_MEDIA_START:
      {
    ...
    case _ActionTypes.REMOVE_MEDIA_COMPLETE:
      {
