...
function deselectAll(playlists) {
  return (0, _object.default)(playlists, function (playlist) {
    return playlist.selected ? (0, _extends4.default)({}, playlist, {
      selected: false
    }) : playlist;
  });
}
...
function updatePlaylist(state, playlistID, modify) {
  ...
  if (playlist) {
    ...
    return (0, _extends4.default)({}, state, {
      playlists: (0, _extends4.default)({}, state.playlists, (_extends2 = {}, _extends2[playlistID] = modify(playlist), _extends2))
    });
  }
...
function updatePlaylistItems(state, playlistID, modify) {
  ...
  if (playlist) {
    ...
    if (state.selectedPlaylistID === playlistID && nextFilter) {
      nextFilter = (0, _extends4.default)({}, nextFilter, {
        items: modify(nextFilter.items || [], playlist)
      });
    }

    return (0, _extends4.default)({}, state, {
      playlistItems: (0, _extends4.default)({}, state.playlistItems, (_extends3 = {}, _extends3[playlistID] = modify(media || [], playlist), _extends3)),
...
function setPlaylistLoading(state, id, loading) {
  ...
  return updatePlaylist(state, id, function (playlist) {
    return (0, _extends4.default)({}, playlist, {
      loading: loading
    });
  });
}
...
function reduce(state, action) {
  ...
  switch (type) {
    ...
    case _playlists.FILTER_PLAYLIST_ITEMS_COMPLETE:
      {
        ...
        return (0, _extends4.default)({}, state, {
          currentFilter: (0, _extends4.default)({}, currentFilter, {
            items: items
          })
        });
      }
    ...
    case _playlists.CREATE_PLAYLIST_COMPLETE:
      ...
      return (0, _extends4.default)({}, state, {
        playlists: (0, _objectAssign.default)(deselectAll((0, _except.default)(state.playlists, "" + meta.tempId)), (_assign2 = {}, _assign2[payload.playlist._id] = (0, _extends4.default)({}, payload.playlist, {
          selected: true
        }), _assign2)),
    ...
    case _playlists.UPDATE_MEDIA_START:
      return updatePlaylistItems(state, payload.playlistID, function (items) {
        return items.map(function (media) {
          return media && media._id === payload.mediaID ? (0, _extends4.default)({}, media, {
            loading: true
          }) : media;
        });
      });
    ...
    case _playlists.UPDATE_MEDIA_COMPLETE:
      return updatePlaylistItems(state, payload.playlistID, function (items) {
        return items.map(function (media) {
          return media && media._id === payload.mediaID ? (0, _extends4.default)({}, media, payload.media, {
            loading: false
          }) : media;
        });
      });
    ...
    case _playlists.MOVE_MEDIA_START:
      {
        ...
        return updatePlaylistItems(state, payload.playlistID, function (items) {
          return items.map(function (media) {
            return media && (0, _extends4.default)({}, media, {
