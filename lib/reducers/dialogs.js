...
function reduce(state, action) {
  ...
  switch (type) {
    case _ActionTypes.OPEN_EDIT_MEDIA_DIALOG:
      return openDialog(state, 'editMedia', payload);

    case _ActionTypes.CLOSE_EDIT_MEDIA_DIALOG:
      return closeDialog(state, 'editMedia');

    case _ActionTypes.OPEN_PREVIEW_MEDIA_DIALOG:
      return openDialog(state, 'previewMedia', payload);

    case _ActionTypes.CLOSE_PREVIEW_MEDIA_DIALOG:
      return closeDialog(state, 'previewMedia');

    case _ActionTypes.OPEN_LOGIN_DIALOG:
      return openDialog(state, 'login', payload);

    case _ActionTypes.CLOSE_LOGIN_DIALOG:
