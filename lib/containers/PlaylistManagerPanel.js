...
var _Panel = require('../components/PlaylistManager/Panel');
...
var onMoveToFirst = function onMoveToFirst(playlist) {
  return function (media, selection) {
    return (0, _PlaylistActionCreators.moveMedia)(playlist, selectionOrOne(media, selection), { at: 'start' });
  };
};
var onMoveToLast = function onMoveToLast(playlist) {
  return function (media, selection) {
    return (0, _PlaylistActionCreators.moveMedia)(playlist, selectionOrOne(media, selection), { at: 'end' });
  };
};
...
var mergeProps = function mergeProps(state, _ref2, props) {
  ...
  return (0, _extends3.default)({}, props, state, (0, _redux.bindActionCreators)({
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps, mergeProps)(_Panel2.default);
