...
var DragLayerContainer = (_dec = (0, _reactDnd.DragLayer)(function (monitor) {
  return {
...
exports.default = DragLayerContainer;

DragLayerContainer.propTypes = process.env.NODE_ENV !== "production" ? {
  type: _react2.default.PropTypes.oneOf([_DDItemTypes.MEDIA, _DDItemTypes.WAITLIST_USER]),
