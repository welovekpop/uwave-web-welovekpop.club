import { CLOSE_RESET_PASSWORD_DIALOG, OPEN_EDIT_MEDIA_DIALOG, CLOSE_EDIT_MEDIA_DIALOG, OPEN_PREVIEW_MEDIA_DIALOG, CLOSE_PREVIEW_MEDIA_DIALOG, OPEN_LOGIN_DIALOG, CLOSE_LOGIN_DIALOG } from '../constants/actionTypes/dialogs';
...
export function closeResetPasswordDialog() {
  return {
    type: CLOSE_RESET_PASSWORD_DIALOG
  };
}
