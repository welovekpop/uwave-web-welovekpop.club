...
export function moveMedia(playlistID, medias, opts) {
  return function (dispatch, getState) {
    ...
    return dispatch(put("/playlists/" + playlistID + "/move", _extends({
      items: items
    }, location), {
      onStart: function onStart() {
