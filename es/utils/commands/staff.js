...
import { userListSelector, isManagerSelector } from '../../selectors/userSelectors';
...
register('userrole', 'Assign a different role to a user. Syntax: "/userrole username role"', {
