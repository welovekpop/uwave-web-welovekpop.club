...
import { djSelector, isCurrentDJSelector, canSkipSelector, endTimeSelector } from '../selectors/boothSelectors';
import { activePlaylistSelector, nextMediaSelector } from '../selectors/playlistSelectors';
import { currentUserSelector } from '../selectors/userSelectors';
import { baseEtaSelector, userInWaitlistSelector, isLockedSelector } from '../selectors/waitlistSelectors';
...
function mapDispatchToProps(dispatch) {
  return bindActionCreators({
    ...
    togglePlaylistManager: togglePlaylistManager,
